...
class ProductoController extends AbstractController
{
    ...
    {
        return $this->render('logistica/producto/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, ProductoRepository $productoRepository): Response
    {
        ...
        return $this->render('logistica/producto/new.html.twig', [
            'producto' => $producto,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Producto $producto, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('logistica/producto/edit.html.twig', [
            'producto' => $producto,
            'form' => $form,
        ]);
    }

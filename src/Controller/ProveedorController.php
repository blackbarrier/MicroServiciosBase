...
class ProveedorController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('logistica/proveedor/new.html.twig', [
            'proveedor' => $proveedor,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('logistica/proveedor/show.html.twig', [
            'proveedor' => $proveedor,
        ]);
    }
    ...
    public function edit(Request $request, Proveedor $proveedor, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('logistica/proveedor/edit.html.twig', [
            'proveedor' => $proveedor,
            'form' => $form,
        ]);
    }

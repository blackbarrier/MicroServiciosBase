...
$('#styleSelector').append('' +
    ...
    '<ul>' +
        '<li>' +            
            '<p class="selector-title">Modo oscuro</p>' + 
            '<span class="text-muted">Seleccione para aplicar</span>'+
        '</li>' +
        '<li>' +
    ...
    '<div class="style-cont m-t-10">' +
        ...
        '<ul>' +
            ...
            '</li>' +
            '<li>' +
                '<p class="selector-title">Navbar imagen</p>' +
            '</li>' +
            '<li class="theme-option">' +
                '<div class="theme-color">' +
...
'<ul>'+
    '<li>' +
        '<a href="#" class="btn btn-success btn-block m-r-15 m-t-10 m-b-10">Mi perfil</a>' +
    ...
    '<li class="text-center">' +
        '<span class="text-center f-18 m-t-15 m-b-15 d-block">Contacto MicroServicios</span>' +
        '<a href="https://www.facebook.com/codedthemes" target="_blank" class="btn btn-facebook soc-icon m-b-20"><i class="fa fa-envelope-o"></i></a>' +
